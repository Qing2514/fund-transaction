...
public class PurchaseController {
    ...
    public AjaxResult findPurchase(@PathVariable Integer state, @PathParam("id") String id,
                                   @PathParam("userName") String userName, @PathParam("productName") String productName,
